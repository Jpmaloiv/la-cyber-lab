        ...
        return (
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false} >
                ...
                <Input
                    ...
                    rightIcon={<TouchableOpacity style={this.state.oldPassword && this.state.focusOldPw ? { display: 'initial' } : { display: 'none' }}><IconFeather name='x-circle' onPress={() => this.setState({ oldPassword: null }, this.oldPassword.clear())} color='#fa4969' size={15} style={{ paddingRight: 15 }} /></TouchableOpacity>}
                />
                <Input
                    ...
                    rightIcon={<TouchableOpacity style={this.state.password && this.state.focusPw ? { display: 'initial' } : { display: 'none' }}><IconFeather name='x-circle' onPress={() => this.setState({ password: null }, this.password.clear())} color='#fa4969' size={15} style={{ paddingRight: 15 }} /></TouchableOpacity>}
                />
                <Input
                    ...
                    rightIcon={<TouchableOpacity style={this.state.confirmPw && this.state.focusCpw ? { display: 'initial' } : { display: 'none' }}><IconFeather name='x-circle' onPress={() => this.setState({ confirmPw: null }, this.confirmPw.clear())} color='#fa4969' size={15} style={{ paddingRight: 15 }} /></TouchableOpacity>}
